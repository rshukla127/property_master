		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Property Attributes Overview",
									"targetURL": "#compublicstoragepao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compublicstoragepao-display": {
								"semanticObject": "compublicstoragepao",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.public.storage.pao",
									"url": sap.ui.require.toUrl("com/public/storage/pao")
								}
							}
						}
					}
